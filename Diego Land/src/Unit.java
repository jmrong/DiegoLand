...
public class Unit {
	...
	public static int[][] stats_unit = {{3, 3, 1, 20}, {2, 2, 1, 20}, {6, 1, 6, 20}, {5, 3, 3, 20}, {4, 5, 2, 45}, {8, 2, 7, 30}, {15, 2, 6, 20}, {9, 7, 4, 100}, {12, 4, 10, 85}};
	public static String[] names_unit = {"Infantry", "Medic", "Sniper", "Grenadier", "Tank", "Fighter Jet", "Bomber", "T-80 Rodriguez", "C.H.R.I.Scopter"};
	...
	public static int[][] req_unit = {{1, 1}, {1, 1}, {2, 1}, {2, 1}, {2, 2}, {3, 3}, {3, 3}, {4, 2}, {4, 3}};
